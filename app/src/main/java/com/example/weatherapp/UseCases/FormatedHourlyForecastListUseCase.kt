...
class FormatedHourlyForecastListUseCase @Inject constructor () {
    fun gethourlyforecastlist(hourlyforecast: HourlyForecastResponse,collector: UseCaseCollector): ArrayList<Item0> {
